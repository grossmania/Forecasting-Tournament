...
dat$compare_to_naive_linear_MASE <- factor(dat$MASE_cutoff_Naive_linear, levels = c(0, 1),
                          labels = c("Below Naive linear", "Above Naive linear"))

dat$compare_to_naive_rwf_MASE <- factor(dat$MASE_cutoff_Naive_rwf, levels = c(0, 1),
                          labels = c("Below Naive rwf", "Above Naive rwf"))
...
dat$compare_to_naive_linear_MASE_w2 <- factor(dat$MASE_cutoff_Naive_linear_w2, levels = c(0, 1),
                          labels = c("Below Naive linear", "Above Naive linear"))

dat$compare_to_naive_rwf_MASE_w2 <- factor(dat$MASE_cutoff_Naive_rwf_w2, levels = c(0, 1),
                          labels = c("Below Naive rwf", "Above Naive rwf"))
