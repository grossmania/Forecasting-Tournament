...
```{r Import revised submission justifications for phase 2, eval=FALSE, include=FALSE}

dat_justification <- read.csv("review_justification_merged.csv", stringsAsFactors = FALSE)
dat_justification <- dat_justification[, c("ResponseId", "team_name", "domain", "dataReceived_Final", "theoreticalInsight_Final", "externalEvent_Final")]
...
#                      "counterNum", "dataReceived_Final", "theoreticalInsight_Final", "externalEvent_Final", "parameters_coded"     
#                
#                
# )]
