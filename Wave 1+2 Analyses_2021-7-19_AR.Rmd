...
dat <- read.csv("Wave1+2data_2021-07-26.csv", stringsAsFactors = FALSE)
...
emtrends(model.long.phase1.conf,specs=pairwise~domain*Month0,var="confidence") #get trends for beginning, middle and end.XXXX
