...
dat <- read.csv("/Users/guoxinqieve/Applications/OneDrive - UC San Diego/Forecasting-Tournament/dat_for_analyses.csv", stringsAsFactors = FALSE)
dat_long <- read.csv("/Users/guoxinqieve/Applications/OneDrive - UC San Diego/Forecasting-Tournament/dat_long.csv", stringsAsFactors = FALSE)

```

```{r get simulated benchmark data & add RW to data}
#add simulation benchmarks
load("/Users/guoxinqieve/Applications/OneDrive - UC San Diego/Forecasting-Tournament/sim/BenchmarkData_Combined.RData")
...
load("/Users/guoxinqieve/Applications/OneDrive - UC San Diego/Forecasting-Tournament/sim/BenchmarkData_Combined_W2.RData")
...
historical <- read.csv("/Users/guoxinqieve/Applications/OneDrive - UC San Diego/Forecasting-Tournament/historical_data.csv")
