...
* [R script to get started with setting up working environment and install relevant packages](https://github.com/grossmania/Forecasting-Tournament/blob/main/GET_STARTED.R)
