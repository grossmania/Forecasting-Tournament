...
phase1$MASE1_cut<-ifelse(phase1$MASE1_w1<1,"Below Naive",ifelse(phase1$MASE1_w1>1,"Above Naive",NA))

proportions(xtabs( ~ MASE1_cut+isExpert.factor,phase1),"isExpert.factor")*100 #in total

proportions(xtabs( ~ MASE1_cut+Method.code,phase1),"Method.code")*100
