...
lifesat <- dat_long %>% subset(domain == "lifesat" & phase == 1) #note that this is only phase 1, ought to be adjusted to include update predictions for the new six months!!!
