...
model.phase1.lmer<-  lmer(log(MASE1_w1)~domain*Method.code+(1|ResponseId), data=phase1)

model.phase1<-  glmer(MASE1_w1~domain*Method.code+(1|ResponseId), data=phase1, family=poisson)
